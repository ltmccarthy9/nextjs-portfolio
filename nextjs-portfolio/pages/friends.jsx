    ...
    <div className='w-full'>
      ...
      <div className='max-w-[1240px] flex flex-col mx-auto p-2 pt-8'>
        <div className='w-full'>
            ...
            <div className='my-12'>
              <iframe className='m-auto' width="1280" height="720" src="https://www.youtube.com/embed/DTRD7qGdLQE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </div>
        </div>
      </div>
    </div>
